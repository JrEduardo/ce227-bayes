## =====================================================================
## Exemplo para ilustração que a uitlização de p-valor também é
## subjetiva
##                                                        Eduardo Junior
##                                                    edujrrib@gmail.com
##                                                            2016-03-28
...
##----------------------------------------------------------------------
## (P-valor subjetivo) Para uma moeda honesta têm-se probabilidade 1/2
## de obtenção de "cara" ou "coroa". Um grupo de alunos encontrou uma
## moeda com um pequena deformação e decidiram avaliar estatisticamente
## a hipótese de que a moeda permanece honesta. Primeiramente João levou
## a moeda para casa e decidiu jogá-la 20 vezes obtendo 6 caras. Maria,
## no outro dia, ficou com a moeda para avaliar a hipótese, ela realizou
## lançamentos até observar 6 caras, necessitou-se de 20. No terceiro
## dia José foi realizar o experimento para testar a hipótese, ele
## decidiu realizar os lançamentos durante a noite, foram 20 lançamentos
## feitos até que sua mãe o chamou para jantar, ele havia obtido 6
## caras. Calcule os p-valores para a hipótese em teste para cada
## experimento e conclua a respeito da hipótese sob um nível de
